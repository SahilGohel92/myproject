<div class="container">
  ...
  <?php
   ...
   $cid = $row['category_id'];
  //  print_r($row);
   echo "<h4 class='mb-15' style='font-size:18px; text-decoration:none; color:#1c7194;'>
    Question : ".$row['title']."
</h4>";

   echo "<p class='mb-15'>".$row['description']."</p>";
   include("answers.php");
  ?>
  ...
  <div class="col-4">
          ...
          <?php
            ...
            foreach ($result as $row) {
                ...
                <h4><a style='font-size:18px; text-decoration:none; color:#1c7194;' href=?q-id=$id>$title</a></h4>
                </div>";
            }
            ?>
  </div>
